...
const types = [
  ...
  },
  {
    icon: CalendarDays,
    title: "Meeting Rooms",
    desc: "Tech-equipped rooms bookable by the hour. Members and guests welcome.",
    href: "/meeting-rooms",
    from: "From £25/hour",
    ...
    <section className="py-28 px-4 sm:px-6 lg:px-8 bg-[#F4F1EA]">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-14">
          <ScrollReveal>
            <div>
              <p className="text-[11px] font-semibold tracking-[0.2em] uppercase text-[#E8622A] mb-4">Space types</p>
              <h2
          ...
          {types.map((type, i) => {
            ...
            return (
              <ScrollReveal key={type.title} delay={i * 0.06}>
                <Link
                  href={type.href}
                  className="group relative overflow-hidden rounded-2xl bg-white hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 block"
                >
