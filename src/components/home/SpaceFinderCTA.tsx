  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[#F4F1EA]">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-[#09090F]/60 text-lg mb-10 max-w-xl mx-auto leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link
            href="/spaces"
            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-[#09090F] font-semibold rounded-xl border border-[#09090F]/15 hover:border-[#E8622A] hover:text-[#E8622A] transition-colors text-lg"
          >
            Browse all spaces
          </Link>
        </div>
        <p className="text-xs text-[#09090F]/40 mt-6">Takes less than 2 minutes. No commitment required.</p>
      </div>
    </section>
  );
}
