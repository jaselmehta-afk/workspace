        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          {main && (
            <ScrollReveal className="lg:col-span-7" delay={0.05}>
              <Link href={`/spaces/${main.slug}`} className="group block relative overflow-hidden rounded-3xl h-full min-h-[480px] lg:min-h-[560px]">
                {/* Ghost index */}
                <span
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            {rest.map((space, i) => (
              <ScrollReveal key={space.id} delay={0.12 + i * 0.08}>
                <Link href={`/spaces/${space.slug}`} className="group block relative overflow-hidden rounded-3xl h-[240px] sm:h-[265px]">
                  {/* Ghost index */}
                  <span
